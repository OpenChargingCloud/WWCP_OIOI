                        ...
                        IComparable
    {
                                       ...
                                       OnExceptionDelegate                OnException        = null)
        {
            ...
            catch (Exception e)
            {
                ...
                OnException?.Invoke(Timestamp.Now, UserText, e);
                                       ...
                                       OnExceptionDelegate                OnException        = null)
        {
            ...
            try
            {
                ...
                User = new User(UserJSON.MapValueOrFail   ("identifier",
                                ...
                                UserJSON.MapValueOrFail   ("identifier-type",
                                                           value => IdentifierTypesExtensions.Parse(value.Value<String>()),
            ...
            catch (Exception e)
            {
                ...
                OnException?.Invoke(Timestamp.Now, UserJSON, e);
        ...
        public JObject ToJSON(CustomJObjectSerializerDelegate<User> CustomUserSerializer  = null)
        {
            ...
            var JSON = JSONObject.Create(
                           ...
                           new JProperty("identifier-type",  IdentifierType.AsText()),
